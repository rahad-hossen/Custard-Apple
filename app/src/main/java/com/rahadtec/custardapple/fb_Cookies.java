...
public class fb_Cookies extends SQLiteOpenHelper { // SQLiteOpenHelper যোগ করা হয়েছে

    private static final String DATABASE_NAME = "Custard_Cookies.db";
    private static final int DATABASE_VERSION = 2;

    // টেবিল ও কলামের নাম
    public static final String TABLE_NAME = "user_fb_cookies";
    public static final String COL_ID = "id";
    public static final String COL_USERNAME = "uid";
    public static final String COL_PASSWORD = "password";
    public static final String COL_SECRET_KEY = "cookies";

    public fb_Cookies(Context context) {
