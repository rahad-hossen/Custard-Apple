...
public class fb_mother extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fb_mother);
        ...
        if (!username.isEmpty()){
            ...
            Toast.makeText(fb_mother.this, "Please re-enter.",Toast.LENGTH_LONG).show();
            finishAffinity();
        }

        // ৩. Add বাটনে ক্লিক করলে ডাটা এন্ট্রি স্ক্রিনে যাবে
        addBtn.setOnClickListener(v -> {
            Intent intent = new Intent(fb_mother.this, fb_home.class);
    ...
    public void exportToDownloads(String file_Name) {
        fb_Cookies dbHelper = new fb_Cookies(this);
        ...
        String[] headers = {"uid", "password", "cookies"};
